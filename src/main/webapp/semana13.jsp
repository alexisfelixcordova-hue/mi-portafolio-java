...
<head>
    ...
    <title>Semana 13 | Portafolio Pixel</title>
    ...
    <div class="nav-desktop-wrap">
        <nav class="nav-desktop">
            <ul>
                ...
                <li><a href="semana13.jsp" class="activo"><span class="nivel-num">13</span>Semana 13</a></li>
            </ul>
        </nav>
    </div>
...
<nav class="nav-mobile" id="navMobile">
    <ul>
        ...
        <li><a href="semana13.jsp" class="activo">Semana 13</a></li>
    </ul>
</nav>
...
<div class="migas">
    <div class="contenedor">
        <a href="principal.jsp">Inicio</a> <span>/</span> <span class="migas-actual">Semana 13</span>
    </div>
</div>
...
<section class="nivel-hero">
    <div class="contenedor">
        <span class="nivel-tag">NIVEL 13 / 13</span>
        <h1>Proyecto Integrador Final</h1>
        <p>Proyecto final del curso que integra todos los conceptos vistos durante las semanas anteriores.</p>
    </div>
</section>
        ...
        <div class="nivel-grid">
            ...
            <div class="nivel-imagen">
                <div class="pantalla-juego">
                    ...
                    <img src="img/semana13.png" alt="Captura del ejercicio Semana 13">
                </div>
            </div>
            ...
            <div class="nivel-info">
                ...
                <p>Este proyecto reúne estructuras de control, arreglos, funciones, programación orientada a objetos y manejo de excepciones en una sola aplicación completa.</p>

                <ul class="nivel-lista">
                    <li><span>🟡</span> Integración de todos los temas</li>
                    <li><span>🟡</span> Aplicación completa funcional</li>
                    <li><span>🟡</span> Buenas prácticas de código</li>
                    <li><span>🟡</span> Interfaz Java + JSP</li>
                </ul>

                <div class="nivel-acciones">
                    <a href="docs/Semana13.pdf" class="btn1 btn-descarga" download>
                        ⬇ Descargar Ejercicio
                    </a>
