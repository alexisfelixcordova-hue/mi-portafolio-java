...
<head>
    ...
    <title>Semana 11 | Portafolio Pixel</title>
    ...
    <div class="nav-desktop-wrap">
        <nav class="nav-desktop">
            <ul>
                ...
                <li><a href="semana11.jsp" class="activo"><span class="nivel-num">11</span>Semana 11</a></li>
...
<nav class="nav-mobile" id="navMobile">
    <ul>
        ...
        <li><a href="semana11.jsp" class="activo">Semana 11</a></li>
...
<div class="migas">
    <div class="contenedor">
        <a href="principal.jsp">Inicio</a> <span>/</span> <span class="migas-actual">Semana 11</span>
    </div>
</div>
...
<section class="nivel-hero">
    <div class="contenedor">
        <span class="nivel-tag">NIVEL 11 / 13</span>
        <h1>Herencia y Polimorfismo</h1>
        <p>Programa que aplica herencia y polimorfismo entre clases relacionadas en Java.</p>
    </div>
</section>
        ...
        <div class="nivel-grid">
            ...
            <div class="nivel-imagen">
                <div class="pantalla-juego">
                    ...
                    <img src="img/semana11.png" alt="Captura del ejercicio Semana 11">
                </div>
            </div>
            ...
            <div class="nivel-info">
                ...
                <p>Se define una jerarquía de clases donde las subclases heredan atributos y métodos de una clase base, sobrescribiendo comportamientos mediante polimorfismo.</p>

                <ul class="nivel-lista">
                    <li><span>🟡</span> Clases base y derivadas</li>
                    <li><span>🟡</span> Sobrescritura de métodos</li>
                    <li><span>🟡</span> Polimorfismo en acción</li>
                    <li><span>🟡</span> Interfaz Java + JSP</li>
                </ul>

                <div class="nivel-acciones">
                    <a href="docs/Semana11.pdf" class="btn1 btn-descarga" download>
                        ⬇ Descargar Ejercicio
                    </a>
