...
<head>
    ...
    <title>Semana 12 | Portafolio Pixel</title>
    ...
    <div class="nav-desktop-wrap">
        <nav class="nav-desktop">
            <ul>
                ...
                <li><a href="semana12.jsp" class="activo"><span class="nivel-num">12</span>Semana 12</a></li>
...
<nav class="nav-mobile" id="navMobile">
    <ul>
        ...
        <li><a href="semana12.jsp" class="activo">Semana 12</a></li>
...
<div class="migas">
    <div class="contenedor">
        <a href="principal.jsp">Inicio</a> <span>/</span> <span class="migas-actual">Semana 12</span>
    </div>
</div>
...
<section class="nivel-hero">
    <div class="contenedor">
        <span class="nivel-tag">NIVEL 12 / 13</span>
        <h1>Manejo de Excepciones</h1>
        <p>Programa que implementa manejo de excepciones y validaciones avanzadas de datos.</p>
    </div>
</section>
        ...
        <div class="nivel-grid">
            ...
            <div class="nivel-imagen">
                <div class="pantalla-juego">
                    ...
                    <img src="img/semana12.png" alt="Captura del ejercicio Semana 12">
                </div>
            </div>
            ...
            <div class="nivel-info">
                ...
                <p>Se controlan errores en tiempo de ejecución mediante bloques try-catch-finally, evitando que el programa se detenga ante datos inválidos.</p>

                <ul class="nivel-lista">
                    <li><span>🟡</span> Bloques try-catch-finally</li>
                    <li><span>🟡</span> Excepciones personalizadas</li>
                    <li><span>🟡</span> Validaciones avanzadas</li>
                    <li><span>🟡</span> Interfaz Java + JSP</li>
                </ul>

                <div class="nivel-acciones">
                    <a href="docs/Semana12.pdf" class="btn1 btn-descarga" download>
                        ⬇ Descargar Ejercicio
                    </a>
