...
<head>
    ...
    <title>Semana 1 | Portafolio Pixel</title>
...
<header>
    ...
    <div class="nav-desktop-wrap">
        <nav class="nav-desktop">
            <ul>
                <li><a href="semana1.jsp" class="activo"><span class="nivel-num">1</span>Semana 1</a></li>
...
<nav class="nav-mobile" id="navMobile">
    <ul>
        <li><a href="semana1.jsp" class="activo">Semana 1</a></li>
...
<div class="migas">
    <div class="contenedor">
        <a href="principal.jsp">Inicio</a> <span>/</span> <span class="migas-actual">Semana 1</span>
    </div>
</div>
