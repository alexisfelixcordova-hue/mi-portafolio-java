...
<head>
    ...
    <title>Semana 7 | Portafolio Pixel</title>
    ...
    <div class="nav-desktop-wrap">
        <nav class="nav-desktop">
            <ul>
                ...
                <li><a href="semana7.jsp" class="activo"><span class="nivel-num">7</span>Semana 7</a></li>
...
<nav class="nav-mobile" id="navMobile">
    <ul>
        ...
        <li><a href="semana7.jsp" class="activo">Semana 7</a></li>
...
<div class="migas">
    <div class="contenedor">
        <a href="principal.jsp">Inicio</a> <span>/</span> <span class="migas-actual">Semana 7</span>
    </div>
</div>
...
<section class="nivel-hero">
    <div class="contenedor">
        <span class="nivel-tag">NIVEL 07 / 13</span>
        <h1>Arreglos Unidimensionales</h1>
        <p>Programa que procesa datos almacenados en arreglos unidimensionales.</p>
    </div>
</section>
        ...
        <div class="nivel-grid">
            ...
            <div class="nivel-imagen">
                <div class="pantalla-juego">
                    ...
                    <img src="img/semana7.png" alt="Captura del ejercicio Semana 7">
                </div>
            </div>
            ...
            <div class="nivel-info">
                ...
                <p>Se cargan datos en un arreglo unidimensional para luego procesarlos: búsquedas, sumatorias, promedios y ordenamientos básicos.</p>

                <ul class="nivel-lista">
                    <li><span>🟡</span> Carga de datos en arreglo</li>
                    <li><span>🟡</span> Recorrido y procesamiento</li>
                    <li><span>🟡</span> Cálculo de promedios</li>
                    <li><span>🟡</span> Interfaz Java + JSP</li>
                </ul>

                <div class="nivel-acciones">
                    <a href="docs/Semana7.pdf" class="btn1 btn-descarga" download>
                        ⬇ Descargar Ejercicio
                    </a>
