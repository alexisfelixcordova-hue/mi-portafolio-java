...
<head>
    ...
    <title>Semana 9 | Portafolio Pixel</title>
    ...
    <div class="nav-desktop-wrap">
        <nav class="nav-desktop">
            <ul>
                ...
                <li><a href="semana9.jsp" class="activo"><span class="nivel-num">9</span>Semana 9</a></li>
...
<nav class="nav-mobile" id="navMobile">
    <ul>
        ...
        <li><a href="semana9.jsp" class="activo">Semana 9</a></li>
...
<div class="migas">
    <div class="contenedor">
        <a href="principal.jsp">Inicio</a> <span>/</span> <span class="migas-actual">Semana 9</span>
    </div>
</div>
...
<section class="nivel-hero">
    <div class="contenedor">
        <span class="nivel-tag">NIVEL 09 / 13</span>
        <h1>Funciones y Métodos</h1>
        <p>Programa que aplica funciones para modularizar el código y reutilizar lógica.</p>
    </div>
</section>
        ...
        <div class="nivel-grid">
            ...
            <div class="nivel-imagen">
                <div class="pantalla-juego">
                    ...
                    <img src="img/semana9.png" alt="Captura del ejercicio Semana 9">
                </div>
            </div>
            ...
            <div class="nivel-info">
                ...
                <p>Se dividen los procesos del programa en funciones independientes, mejorando la organización, legibilidad y reutilización del código.</p>

                <ul class="nivel-lista">
                    <li><span>🟡</span> Definición de métodos</li>
                    <li><span>🟡</span> Paso de parámetros</li>
                    <li><span>🟡</span> Reutilización de código</li>
                    <li><span>🟡</span> Interfaz Java + JSP</li>
                </ul>

                <div class="nivel-acciones">
                    <a href="docs/Semana9.pdf" class="btn1 btn-descarga" download>
                        ⬇ Descargar Ejercicio
                    </a>
