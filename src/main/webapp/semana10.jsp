...
<head>
    ...
    <title>Semana 10 | Portafolio Pixel</title>
    ...
    <div class="nav-desktop-wrap">
        <nav class="nav-desktop">
            <ul>
                ...
                <li><a href="semana10.jsp" class="activo"><span class="nivel-num">10</span>Semana 10</a></li>
...
<nav class="nav-mobile" id="navMobile">
    <ul>
        ...
        <li><a href="semana10.jsp" class="activo">Semana 10</a></li>
...
<div class="migas">
    <div class="contenedor">
        <a href="principal.jsp">Inicio</a> <span>/</span> <span class="migas-actual">Semana 10</span>
    </div>
</div>
...
<section class="nivel-hero">
    <div class="contenedor">
        <span class="nivel-tag">NIVEL 10 / 13</span>
        <h1>Programación Orientada a Objetos</h1>
        <p>Programa que define clases, atributos y métodos aplicando los principios de la POO.</p>
    </div>
</section>
        ...
        <div class="nivel-grid">
            ...
            <div class="nivel-imagen">
                <div class="pantalla-juego">
                    ...
                    <img src="img/semana10.png" alt="Captura del ejercicio Semana 10">
                </div>
            </div>
            ...
            <div class="nivel-info">
                ...
                <p>Se modelan entidades del mundo real como clases con sus atributos y comportamientos, instanciando objetos para resolver el problema planteado.</p>

                <ul class="nivel-lista">
                    <li><span>🟡</span> Definición de clases</li>
                    <li><span>🟡</span> Atributos y constructores</li>
                    <li><span>🟡</span> Instanciación de objetos</li>
                    <li><span>🟡</span> Interfaz Java + JSP</li>
                </ul>

                <div class="nivel-acciones">
                    <a href="docs/Semana10.pdf" class="btn1 btn-descarga" download>
                        ⬇ Descargar Ejercicio
                    </a>
