...
<head>
    ...
    <title>Semana 8 | Portafolio Pixel</title>
    ...
    <div class="nav-desktop-wrap">
        <nav class="nav-desktop">
            <ul>
                ...
                <li><a href="semana8.jsp" class="activo"><span class="nivel-num">8</span>Semana 8</a></li>
...
<nav class="nav-mobile" id="navMobile">
    <ul>
        ...
        <li><a href="semana8.jsp" class="activo">Semana 8</a></li>
...
<div class="migas">
    <div class="contenedor">
        <a href="principal.jsp">Inicio</a> <span>/</span> <span class="migas-actual">Semana 8</span>
    </div>
</div>
...
<section class="nivel-hero">
    <div class="contenedor">
        <span class="nivel-tag">NIVEL 08 / 13</span>
        <h1>Arreglos Bidimensionales</h1>
        <p>Programa que trabaja con matrices (arreglos bidimensionales) para el procesamiento de datos.</p>
    </div>
</section>
        ...
        <div class="nivel-grid">
            ...
            <div class="nivel-imagen">
                <div class="pantalla-juego">
                    ...
                    <img src="img/semana8.png" alt="Captura del ejercicio Semana 8">
                </div>
            </div>
            ...
            <div class="nivel-info">
                ...
                <p>Se construye una matriz de datos y se procesan filas y columnas para obtener totales, máximos, mínimos y otros resultados.</p>

                <ul class="nivel-lista">
                    <li><span>🟡</span> Construcción de la matriz</li>
                    <li><span>🟡</span> Recorrido por filas y columnas</li>
                    <li><span>🟡</span> Cálculo de totales</li>
                    <li><span>🟡</span> Interfaz Java + JSP</li>
                </ul>

                <div class="nivel-acciones">
                    <a href="docs/Semana8.pdf" class="btn1 btn-descarga" download>
                        ⬇ Descargar Ejercicio
                    </a>
